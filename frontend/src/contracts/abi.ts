...
export const predictionMarketABI = parseAbi([
  ...
  'function getMarketPool(uint256 marketId) view returns (uint256)',
  'function claimFrozen(uint256 marketId) view returns (bool)',
  'function disputeDeadline(uint256 marketId) view returns (uint256)',
  'function disputeCount(uint256 marketId) view returns (uint256)',
  'function disputePending(uint256 marketId) view returns (bool)',
